...
public class MySQLiteParserBaseListener extends SQLiteParserBaseListener{
    ...
    public Object getObjVal(String strTableName, String inpColName, String inpColVal){
        ...
        switch(colType){
            case "java.lang.Integer": inpColValObj = Integer.parseInt(inpColVal); break;
            case "java.lang.double":
            case "java.lang.Double": inpColValObj = Double.parseDouble(inpColVal); break;
            case "java.lang.String": inpColValObj = inpColVal.toLowerCase(); break;
            case "java.util.Date":
